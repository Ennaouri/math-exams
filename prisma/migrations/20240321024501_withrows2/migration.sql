/*
  ...
  - You are about to drop the `PostDetails` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `UnderCategory` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "public"."Post" DROP CONSTRAINT "Post_underCategory_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."PostDetails" DROP CONSTRAINT "PostDetails_post_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."UnderCategory" DROP CONSTRAINT "UnderCategory_category_id_fkey";
...
-- DropTable
DROP TABLE "public"."PostDetails";

-- DropTable
DROP TABLE "public"."UnderCategory";
